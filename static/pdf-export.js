...
async function exportAllSheetsToPDF() {
    console.log('📄 Exporting all sheets to PDF...');
...
function addPanelSchedulePage(pdf, scheduleData) {
    ...
    // Table
    const headers = ['Cct#', 'Description', 'Devices', 'Load (W)', 'Load (A)', 'Cable', 'Breaker', 'RCD', 'V.Drop', '✓'];
...
function exportCurrentSheetToPDF() {
    console.log('📄 Exporting current sheet to PDF...');
